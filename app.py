...
import pyvibe as pv
from ytmp3 import download_video
...
def index():
    page = pv.Page(
        ...
        navbar=pv.Navbar(
            title="",
            components=[],
            logo="https://www.youtube.com/s/desktop/339bae71/img/favicon_144x144.png",
        ),
    ...
    with page.add_card() as card:
        ...
        with card.add_form(action="/", method="POST") as form:
            form.add_formtext(
                name="url", label="Video URL", placeholder="Enter the URL of the video"
            )
